...
/// The Rune runtime — defines the `rune_*` C symbols codegen
/// imports. Single source: `runtime.c`, compiled into the `rune`
/// binary by `build.rs` for the JIT and compiled again here when
/// the AOT path links a target executable.
